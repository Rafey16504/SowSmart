...
const CropRecommendation = () => {
  ...
  return (
    <div className="font-grotesk bg-gradient-to-tr  from-green-50 via-white to-green-100 min-h-screen flex flex-col items-center">
      ...
      <main className="flex-grow py-10 w-full max-w-5xl px-4">
        {!submitted && !loading && (
        ...
        {recommendation && !loading && (
          <div className="mt-10  text-gray-800 p-8 rounded-3xl max-w-2xl mx-auto animate-fade-in">
      ...
      <footer className="bg-gray-800 p-4 text-center text-white w-full rounded-t-3xl">
